...
JFrame - это объект, который представляет окно на экране. В нем могут находиться кнопки, флажки, поля ввода и т.п. Также окно может иметь строку меню с пунктами. А также окно на любой платформе содержит кнопки сворачивания, разворачивания и закрытия окна.
