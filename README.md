...
- Получается наследоваться от наследного публичного класса и применять его методы. Но если этот класс находится в другом пакете, все его методы должны быть публичными.
